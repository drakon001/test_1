...
import { usePage2Request } from './usePage2Request';
...
import { GeneralError, Page2Container, Page2DataContainer,
   Page2Form, Page2SubmitButton, Spinner } from './StyledComponents';

const homeRoute = "/" satisfies IRoutes;

interface FormFiledsMeta {
  label: string,
  name: keyof Page2FormData,
  type: "date" | "text"
}

const fieldsMeta: FormFiledsMeta[]  = [{
    label:"Дата:",
    type:"date",
    name:"date"
  }, {
